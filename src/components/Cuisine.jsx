          ...
          <div className="flex space-x-4 py-3 items-center">
            ...
            {featuredAreas.map((area) => (
              ...
              onClick={()=>filterByArea(area)}
                key={area}
                className="cursor-pointer text-gray-200 text-5m whitespace-nowrap font-medium hover:text-white transition duration-200 py-1.5 px-4 rounded-full bg-gray-800 border-gray-700 hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-800/50 transform hover:scale-[1.05]"
              >
                {area}
              </Link>
            ))}
